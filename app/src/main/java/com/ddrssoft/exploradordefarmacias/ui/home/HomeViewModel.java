...
public class HomeViewModel extends AndroidViewModel {
    ...
    private static final LatLng Tello =new LatLng(-33.29509, -66.31905);
    private static final LatLng Quintana =new LatLng(-33.29539, -66.31996);
    private static final LatLng SanIsidro=new LatLng(-33.29776, -66.32747);
    private static final LatLng Piramide=new LatLng(-33.29778, -66.31782);
    private static final LatLng Farmacity=new LatLng(-33.30141, -66.33704);
    ...
    public class MapaActual implements OnMapReadyCallback {
        ...
        public void onMapReady(@NonNull GoogleMap googleMap) {
            ...
            if(localizacion != null) {
                ...
                googleMap.addMarker(new MarkerOptions().position(Tello).title("Farmacia Tello"));
                googleMap.addMarker(new MarkerOptions().position(Quintana).title("Farmacia Quintana"));
                googleMap.addMarker(new MarkerOptions().position(SanIsidro).title("Farmacia San Isidro"));
                googleMap.addMarker(new MarkerOptions().position(Piramide).title("Farmacia La Piramide"));
                googleMap.addMarker(new MarkerOptions().position(Farmacity).title("Farmacia Farmacity"));
